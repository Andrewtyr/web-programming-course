/**
 * Вспомогательный модуль для обмена OAuth code на пользователя GitHub (опционально).
 * Роут `auth` может использовать свою реализацию; здесь — отдельный сервис с тестовым префиксом `test_`.
 */
